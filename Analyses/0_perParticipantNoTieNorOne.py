...
preTab.to_csv("pre_production_final_SmallBig_NoTieNorOne.csv", index=False) #Just to save time and do not also have to do it in R
postTab.to_csv("post_production_final_SmallBig_NoTieNorOne.csv", index=False)
q1Tab.to_csv("q1_production_final_SmallBig_NoTieNorOne.csv", index=False)
q2Tab.to_csv("q2_production_final_SmallBig_NoTieNorOne.csv", index=False)
q3Tab.to_csv("q3_production_final_SmallBig_NoTieNorOne.csv", index=False)
q4Tab.to_csv("q4_production_final_SmallBig_NoTieNorOne.csv", index=False)

session0mod6 = tab[(tab["seance"]%6==0)]
session0mod6.to_csv("session0mod6_production_final_SmallBig_NoTieNorOne.csv", index=False)
...
session1mod6.to_csv("session1mod6_production_final_SmallBig_NoTieNorOne.csv", index=False)
...
session2mod6.to_csv("session2mod6_production_final_SmallBig_NoTieNorOne.csv", index=False)
...
session3mod6.to_csv("session3mod6_production_final_SmallBig_NoTieNorOne.csv", index=False)
...
session4mod6.to_csv("session4mod6_production_final_SmallBig_NoTieNorOne.csv", index=False)
...
session5mod6.to_csv("session5mod6_production_final_SmallBig_NoTieNorOne.csv", index=False)
...
session0to2mod6.to_csv("session0to2mod6_production_final_SmallBig_NoTieNorOne.csv", index=False)
...
session3to5mod6.to_csv("session3to5mod6_production_final_SmallBig_NoTieNorOne.csv", index=False)
...
session0to1mod6.to_csv("session0to1mod6_production_final_SmallBig_NoTieNorOne.csv", index=False)
...
session2to3mod6.to_csv("session2to3mod6_production_final_SmallBig_NoTieNorOne.csv", index=False)
...
session4to5mod6.to_csv("session4to5mod6_production_final_SmallBig_NoTieNorOne.csv", index=False)
...
final.to_csv("perParticipant_SmallBig_NoTieNorOne.csv", index=False)

final_complete = final.dropna(how="any").reset_index(drop=True)

final_complete.to_csv("perParticipantWithoutNA_SmallBig_NoTieNorOne.csv", index=False)
